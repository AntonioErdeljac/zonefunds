            ...
            <ul class="nav navbar-nav navbar-brand float-xs-right" style="padding-top: 20px;">
              <li class="nav-item dropdown color-niceblue">
                ...
                <div class="dropdown-menu dropdown-menu-right modal-fade" id="dropdown_account" style="border-radius:0px; box-shadow: 0 1px 3px rgba(0,0,0,.2);">
                  <a class="dropdown-item color-niceblue" href="#" style="color: #2d89e5;"><i class="fa fa-user fa-fw" aria-hidden="true"></i>My Profile</a>
                  <a class="dropdown-item color-niceblue" href="#" style="color: #2d89e5;"><i class="fa fa-cog fa-fw" aria-hidden="true"></i>Account Settings</a>
          ...
          <?php else: ?>
            ...
            <div class="nav navbar-nav navbar-brand float-xs-right" style="padding-top:8px;">
              <form class="form form-inline">
                ...
                <button type="button" id="no_auth_btn_register" class="form-control btn" data-toggle="modal" data-target="#registermodal">Create An Account</button>
              </form>
            </div>
      ...
      <div class="container">
        <div class="row">
          <form class="form-group" method="get" id="search">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="text" class="form-control hidden-md-down" name="ad_search" placeholder="Search" id="search_top" value="<?php echo e($ad_search); ?>">
                      <input type="text" class="form-control hidden-lg-up" name="ad_search" placeholder="Search" id="search_top_mobile" value="<?php echo e($ad_search); ?>">
