                  ...
                  <div class="form-group" style="">
                    <form action="<?php echo e(route('ad.create')); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div>
                        ...
                        <input type="text" class="form-control mb-1" name="ad_title" placeholder="Nudim popravak računala." value="<?php echo e(Request::old('ad_title')); ?>">
                      </div>
                    ...
                    <div class="form-group">
                      <form action="<?php echo e(route('signin')); ?>" method="post">
                        ...
                        <div class="input-group mb-1 input_form">
                          ...
                          <input class="form-control input_form" type="text" name="username" placeholder="John Doe" value="<?php echo e(Request::old('username')); ?>">
                        </div>
              ...
              <a href="<?php echo e(route('ad.show', $ad->id)); ?>" style="text-decoration: none;">
                <div class="card">
                  ...
                  <div class="card-block">
                    <h4 class="card-title"><?php echo e(str_limit($ad->ad_title, 25)); ?></h4>
