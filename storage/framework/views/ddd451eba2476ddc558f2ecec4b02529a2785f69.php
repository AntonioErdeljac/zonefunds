    ...
    <div id="navbar_main" class="nav navbar navbar-light bg-faded hidden-md-down <?php echo e(Auth::check() ? '' : 'mb-3'); ?>">
      <div class="container">
        <div class="row">
              ...
              <form class="form-inline" method="get" id="search">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="ad_search" placeholder="Search" style="border-color: #2d89e5; border-top-style: hidden; border-right-style: hidden; border-left-style: hidden;">
            ...
            <ul class="nav navbar-nav navbar-brand float-xs-left" style="padding-top: 20px;">
              <li class="nav-item dropdown" style="color:#2d89e5;">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:#2d89e5;"><i class="fa fa-clock fa-fw" aria-hidden="true" style="color:#2d89e5;"></i>
                  <?php echo e($ad_sort); ?>
                ...
                <div class="dropdown-menu dropdown-menu-right modal-fade" id="dropdown_account" style="border-radius:0px; box-shadow: 0 1px 3px rgba(0,0,0,.2);">
                  <a class="dropdown-item" href="<?php echo e(route('home')); ?>" style="color:#2d89e5;">Recent</a>
                  <a class="dropdown-item" href="#" style="color:#2d89e5;">Nearest</a>
                  <a class="dropdown-item" href="<?php echo e(route('sort.high')); ?>" style="color:#2d89e5;">Price: Highest</a>
                  <a class="dropdown-item" href="<?php echo e(route('sort.low')); ?>" style="color:#2d89e5;">Price: Lowest</a>
                </div>
              </li>
            </ul>
          ...
          <?php else: ?>
            ...
            <form class="form form-inline">
              <button type="button" class="form-control btn btn-primary border-r-0" id="no_auth_btn" data-toggle="modal" data-target="#loginmodal"><b>Log In</b></button>
              <button type="button" id="no_auth_btn" class="form-control btn btn-primary border-r-0" data-toggle="modal" data-target="#registermodal"><b>Create An Account</b></button>
              </form>
            </div>
