          ...
          <div class="modal-body">
                  <div class="form-group" style="">
                    <form action="<?php echo e(route('ad.create')); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div>
                        <label for="ad_title" style="padding-left:6px;"><b>Ad Title:</b></label>
                        <input type="text" class="form-control mb-3" name="ad_title" placeholder="Nudim popravak računala." value="<?php echo e(Request::old('ad_title')); ?>">
                      </div>

                      <div>
                        <label for="ad_body" style="padding-left:6px;"><b>Ad Description:</b></label>
                        <textarea class="form-control mb-3" rows="5" name="ad_body" placeholder="Popraviti ću bilo koji problem sa računalom ili laptopom, software i hardware."><?php echo e(Request::old('ad_body')); ?></textarea>
                      </div>
                      ...
                      <div class="input-group mb-1">
                          ...
                          <input class="form-control" type="text" name="ad_location" placeholder="Rijeka, Croatia" style="border-color:#2d89e5; border-left-style: hidden; border-top-style: hidden; border-right-style: hidden;" value="<?php echo e(Request::old('ad_location')); ?>">
                        </div>
                      <div class="input-group mb-1">
                    ...
                    <div class="form-group">
                      <form action="<?php echo e(route('signin')); ?>" method="post">
                        ...
                        <div class="input-group mb-1 input_form">
                          <span class="input-group-addon input_form"><i class="fa fa-user fa-fw"></i></span>
                          <input class="form-control input_form" type="text" name="username" placeholder="John Doe">
                        </div>
                  ...
                  <div class="list-group" style="border-radius: 0px;">
                    ...
                    <?php if(Auth::check()): ?>
                      <?php if(Auth::user() == $ad->user): ?>
                        <form class="delete" data-toggle="modal" data-target="#confirmmodal">
                          <button type="button" id="delete" class="form-control btn btn-primary glavni_dio"><i class="fa fa-trash stvori_kantu"></i><p class="p-0 m-0 nestani_text">Delete</p></button>
                        </a>
                      <?php else: ?>
            ...
            <!--<a data-toggle="modal" data-target="#create_ad_modal2" style="text-decoration:none;">-->
                <div class="card">
                  ...
                  <div class="list-group" style="border-radius: 0px;">
                    ...
                    <a class="list-group-item" style="border-bottom-right-radius: 15px; border-bottom-left-radius: 15px; text-decoration: none; color:#2d89e5; border-right-style:hidden; border-left-style: hidden; border-bottom-style: hidden;" href="#"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i>&nbsp; <?php echo e($ad->ad_location); ?></a>
                    <?php if(Auth::check()): ?>
                      <?php if(Auth::user() == $ad->user): ?>
