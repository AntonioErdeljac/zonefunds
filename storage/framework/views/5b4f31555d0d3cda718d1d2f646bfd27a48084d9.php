              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    <form action="<?php echo e(route('ad.update', $ad_select->id)); ?>" method="PATCH" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                       ...
                       <a href="<?php echo e(route('logout')); ?>"> <button class="form-control btn btn-primary border-r-0 mb-1"><i class="fa fa-user fa-fw mr-1" aria-hidden="true"></i>Logout</button> </a>
                        </div>
                    </div>
                  </div>
                </div>
                          ...
                          <!--<a data-toggle="modal" data-target="#create_ad_modal2" style="text-decoration:none;">-->
                              ...
                              <div class="card">
                                ...
                                <div class="card-block">
                                  <h4 class="card-title"><?php echo e($ad_select->ad_title); ?></h4>
                                ...
                                <div class="list-group" style="border-radius: 0px;">
                                  ...
                                  <?php if(Auth::check()): ?>
                                    <?php if(Auth::user() == $ad_select->user): ?>
                                      <a href="<?php echo e(route('ad.delete', $ad_id = $ad_select->id)); ?>">
            ...
            <!--<a data-toggle="modal" data-target="#create_ad_modal2" style="text-decoration:none;">-->
                <div class="card">
                  ...
                  <div class="list-group" style="border-radius: 0px;">
                    ...
                    <a class="list-group-item" style="border-radius: 0px; text-decoration: none; color:#2d89e5; border-right-style:hidden; border-left-style: hidden;" href="#"><i class="fa fa-map-marker fa-fw" aria-hidden="true"></i>&nbsp; <?php echo e($ad->ad_location); ?></a>
                    <?php if(Auth::check()): ?>
                      <?php if(Auth::user() == $ad->user): ?>
                        <a href="<?php echo e(route('ad.delete', $ad_id = $ad->id)); ?>">
                          <button type="submit" id="delete" class="form-control btn btn-primary border-r-0">Delete</button>
