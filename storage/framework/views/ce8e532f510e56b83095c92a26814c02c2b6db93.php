                    ...
                    <?php if(Auth::check()): ?>
                      <?php if(Auth::user() == $ad->user): ?>
                        <form class="delete" action="<?php echo e(route('ad.delete', $ad_id = $ad->id)); ?>">
                          <button type="submit" id="delete" class="form-control btn btn-primary glavni_dio"><i class="fa fa-trash stvori_kantu"></i><p class="p-0 m-0 nestani_text">Delete</p></button>
                        </a>
                      <?php else: ?>
