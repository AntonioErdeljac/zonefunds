    ...
    <div id="navbar_main" class="nav navbar navbar-light bg-faded hidden-md-down">
      <div class="container">
        <div class="row">
            <a class="navbar-brand float-xs-left" href="{{ route('home') }}" >
            ...
            <div class="navbar-brand float-xs-left" style="padding-top:15px;  border-color: #2d89e5 ">
              <form class="form-inline" method="get" action="{{ route('home') }}" id="search">
                <div class="form-group opacity_on_hover">
                  <div class="input-group">
                    <input type="text" class="form-control" name="ad_search" placeholder="Pretraži" id="search_top" value="{{$ad_search}}">
             ...
             <option value="recent" {{ $ad_sort == 'recent' ? 'selected' : '' }} class="">Najnovije</option>
             <option value="high" {{ $ad_sort == 'high' ? 'selected' : ''  }} class="">Cijena: Najviša</option>
             <option value="low" {{ $ad_sort == 'low' ? 'selected' : ''  }} class="">Cijena: Najniža</option>
           </select>
              </form>
            </div>
            ...
            <ul class="nav navbar-nav navbar-brand float-xs-right" style="padding-top: 15px;" id="zonefunds-navbar">
              ...
              <li class="nav-item dropdown color-niceblue" id="dropdown-user">
                <a style="color:#2d89e5;" class="nav-link dropdown-toggle opacity_on_hover"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle fa-fw color-niceblue" aria-hidden="true" id="dropdown-user"></i>
                  <span class="color-niceblue">{{ $user->username }}</span>
                </a>
                <div class="border-r-15 dropdown-menu dropdown-menu-right" id="dropdown_account" style="box-shadow: 0 1px 3px rgba(0,0,0,.2);">
                  <a class="dropdown-item color-niceblue" href="{{ route('account') }}" style="color: #2d89e5;"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Moj Profil</a>
                  <a class="dropdown-item color-niceblue" href="{{ route('account.settings') }}" style="color: #2d89e5;"><i class="fa fa-cog fa-fw" aria-hidden="true"></i>Postavke Računa</a>
                  <a class="dropdown-item" href="{{ route('logout') }}" style="color:#2d89e5;"><i class="fa fa-sign-out fa-fw" aria-hidden="true"></i>Odjava</a>
                </div>
              </li>
            </ul>
          @else
    ...
    <nav id="navbar_down" class="navbar navbar-fixed-top hidden-lg-up mb-3" style="text-align: center;">
                ...
                <ul class="nav nav-center">
                  <li><a data-toggle="modal" data-target="#locationmodal" ><i class="fa fa-map-marker fa-2x" style="color: {{$api == 'da' ? '#E54444;' : '#2d89e5;'}}"></i></a></li>
                </ul>
    ...
    <nav id="" class="navbar navbar-fixed-top hidden-lg-up mobile_search dropdown_mobile" style="top:45px; background-color: #f0f0f0">
          <form method="get" action="{{ route('home') }}" id="search">
                <div class="form-group " style="background-color: #f0f0f0">
                    <input type="text" class="form-control opacity_on_hover" name="ad_search" placeholder="Pretraži" id="search_mobile" value="{{$ad_search}}">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        @if(Auth::check())
                         ...
                         <a href="{{ route('logout') }}"> <button class="form-control btn btn-primary border-r-0"><i class="fa fa-sign-out fa-fw mr-1" aria-hidden="true"></i>Odjava</button> 
                         </a>
